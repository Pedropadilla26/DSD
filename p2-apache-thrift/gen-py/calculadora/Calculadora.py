...
class Client(Iface):
    ...
    def multiplicacion_vectores(self, v1, v2):
        ...
        """
        self.send_multiplicacion_vectores(v1, v2)
        return self.recv_multiplicacion_vectores()

    def send_multiplicacion_vectores(self, v1, v2):
        self._oprot.writeMessageBegin('multiplicacion_vectores', TMessageType.CALL, self._seqid)
        args = multiplicacion_vectores_args()
        args.v1 = v1
        args.v2 = v2
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_multiplicacion_vectores(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = multiplicacion_vectores_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "multiplicacion_vectores failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["multiplicacion_vectores"] = Processor.process_multiplicacion_vectores
    ...
    def process_multiplicacion_vectores(self, seqid, iprot, oprot):
        args = multiplicacion_vectores_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = multiplicacion_vectores_result()
        try:
            result.success = self._handler.multiplicacion_vectores(args.v1, args.v2)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("multiplicacion_vectores", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class multiplicacion_vectores_args(object):
    """
    Attributes:
     - v1
     - v2
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('multiplicacion_vectores_args')
        if self.v1 is not None:
            oprot.writeFieldBegin('v1', TType.LIST, 1)
            oprot.writeListBegin(TType.I32, len(self.v1))
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(multiplicacion_vectores_args)
multiplicacion_vectores_args.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'v1', (TType.I32, None, False), None, ),  # 1
    (2, TType.LIST, 'v2', (TType.I32, None, False), None, ),  # 2
)
...
class multiplicacion_vectores_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('multiplicacion_vectores_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
            oprot.writeListBegin(TType.I32, len(self.success))
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(multiplicacion_vectores_result)
multiplicacion_vectores_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.I32, None, False), None, ),  # 0
)
